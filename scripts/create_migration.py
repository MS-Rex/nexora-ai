...
def main():
    ...
    if not os.path.exists("alembic.ini"):
        print(
            "❌ alembic.ini not found. Please run this script from the project root directory."
        )
        sys.exit(1)
    ...
    if success:
        ...
        print("\nNext steps:")
        print(
            "1. Make sure PostgreSQL is running (docker run --name postgres -e POSTGRES_PASSWORD=postgres -p 5432:5432 -d postgres)"
        )
