    ...
    def load_knowledge_base(self, overwrite: bool = False) -> bool:
        ...
        try:
            ...
            if all_documents:
                ...
                logger.info(f"Successfully loaded {len(all_documents)} document chunks from {len(md_files)} files")
                return True
            else:
    ...
    def search_knowledge(
        ...
        try:
            ...
            if self.table_name not in db.table_names():
                logger.warning("Knowledge base table not found. Please load knowledge base first.")
                return []
